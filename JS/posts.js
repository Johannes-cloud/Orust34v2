...
async function getPosts(url){
    ...
    posts.forEach(function(product){
        productContainer.innerHTML +=`<a href="details.html?id=${product.id}"><div class="${product.tags[0].name}">
        <img class="boatImage" alt="${product.name} photo" src="${product.images[0].src};">
